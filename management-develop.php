<?php
$meta_title = 'Find Out How A BID Is Developed & How We Can Help';
$meta_tags = '<meta name="description" content="Find out how a BID is developed from initial feasibility study through to ballot. It can be a long process, but CMS can help you every step of the way." />'; 
$canonical = '<link rel="canonical" href="http://www.centralmanagementltd.com/management-develop.php" />';
include 'header.php'; ?>
	...
	<div class="caseStudyNav">
    	...
    	<div class="row doublepadt">
           ...
           <div class="col-md-8 alignCenter">
                   <p>For a BID to go ahead the ballot must be won on two counts: 
                    straight majority and majority of rateable value. This ensures that the 
                    interests of large and small businesses are protected.</p>
                  
                   <p>The CMS team can take you step by step on this journey - be it
                   a potential town, city or industrial BID - through from the initial
                   feasibility study, to consultation, development of the actual
                   business plan and finally organisation of the ballot.</p>
           	 <!--
                <p>A BID can only be formed following consultation and a ballot in 
                which businesses vote on a BID Proposal for the area. 
    	...
    	<div class="row doublepadt">
           ...
           <div class="col-md-8 alignCenter doublepadb">
